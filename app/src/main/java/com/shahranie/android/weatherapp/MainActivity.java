...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String WEATHER_SOURCE="http://api.openweathermap.org/data/2.5/weather?APPID=82445b6c96b99bc3ffb78a4c0e17fca5&mode=json&id=1735161";
    ...
    private class WeatherDataRetrival extends AsyncTask<Void, Void, String>{
        ...
        protected void onPostExecute(String result) {
            ...
            if(result!=null){
                ...
                try {
                    ...
                    DecimalFormat formatD = new DecimalFormat("# ");//create decimal places method
        ...
        private int getIcon(int code) {
            switch (code)
            {
                ...
                case 800 : return R.drawable.ic_day_clear_large;

                case 801 : return R.drawable.ic_day_few_clouds_large;

                case 802 : return R.drawable.ic_scattered_clouds_large;
                ...
                case 905 : return R.drawable.ic_windy_large;

                case 906 : return R.drawable.ic_hail_large;

                default : return R.drawable.ic_day_clear_large;
